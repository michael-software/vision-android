 ...
 * Thanks to: https://rogerkeays.com/simple-android-file-chooser
 */
...
public class FileChooserDialog {
    ...
    public FileChooserDialog(Context activity) {
        ...
        if(Environment.getExternalStorageDirectory().exists() && Environment.getExternalStorageDirectory().canRead()) {
            ...
            refresh(Environment.getRootDirectory());
        }
    }
    ...
    private void refresh(File path) {
        ...
        if (path.exists()) {
            ...
            if(!Tools.empty(dirs) && !Tools.empty(files)) {
                // convert to an array
                int i = 0;
                String[] fileList;
